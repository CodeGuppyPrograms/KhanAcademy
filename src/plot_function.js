// Plot a function is adapted from the code at 
// https://codeguppy.com/code.html?t=fngraph
// ----------------------------------------------------------------
// https://codeguppy.com is a site with programs for kids and teens
// that can be adapted to Khan Academy
// due to the similarities between the platfomrs
// ----------------------------------------------------------------
...
var drawFunctionAxes = function(x1, x2, y1, y2)
{
    if ( x1 < 0 && x2 >= 0)
    {
...
var plotFunctionGraph = function(ar, x1, x2, y1, y2)
{
...
var getFunctionValues = function(fn, x1, x2, n)
{
    var ar = [];
    var min = Infinity;
    var max = -Infinity;
...
var plotFunction = function(fn, x1, x2)
{
...
var draw = function()
{
    ...
    plotFunction(fn, start, start + 10 * PI);
